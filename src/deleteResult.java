...
public class deleteResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Alert! Result record will be deleted.");
        ...
        jButton10.setText("Delete Result");
        ...
        jButton12.setText("Update Result");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select *from result where rollNo='"+rollNo+"' and cls='"+cls+"'");
            if(rs.next())
            {
