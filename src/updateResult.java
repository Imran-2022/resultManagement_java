...
public class updateResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if(rs.next())
            {
              	st.executeUpdate("update result set bangla='" + bangla + "', english='" + english + "', mathematics='" + mathematics + "',"
        + " science='" + science + "', socialScience='" + socialScience + "', religion='" + religion + "'"
        + " where rollNo='" + rollNo + "' and cls='" + cls + "'");
