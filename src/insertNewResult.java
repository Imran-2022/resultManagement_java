...
String rollNo=jTextField1.getText();
        ...
        try{
            ...
            if(rs.next())
            {
               st.executeUpdate("insert into result (cls, rollNo, bangla, english, mathematics, science, socialScience, religion) values ('" + cls + "','" + rollNo + "','" + bangla + "','" + english + "','" + mathematics + "','" + science + "','" + socialScience + "','" + religion + "')");
