...
public class deleteStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Alert! Student record will be deleted.");
        ...
        jButton9.setText("Delete Result");
        ...
        jButton11.setText("Update Result");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select *from student where rollNo='"+rollNo+"' and cls='"+cls+"'");
            if(rs.next())
            {
                st.executeUpdate("DELETE FROM student WHERE cls='" + cls + "' AND rollNo='" + rollNo + "'");
                st.executeUpdate("DELETE FROM result WHERE cls='" + cls + "' AND rollNo='" + rollNo + "'");
